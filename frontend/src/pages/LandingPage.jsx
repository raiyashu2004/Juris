...
export default function LandingPage({ onNavigate }) {
  ...
  return (
    <div className="bg-background text-on-background font-body-md text-body-md antialiased min-h-screen flex flex-col w-full overflow-x-hidden">
      {/* ── Navbar ──────────────────────────────────── */}
      <nav className="fixed top-0 left-0 right-0 h-16 border-b border-outline-variant bg-surface-container-lowest/95 backdrop-blur-md z-50">
        <div className="max-w-[1400px] h-full mx-auto px-3 sm:px-6 md:px-8 lg:px-12 flex justify-between items-center">
          <div 
          ...
          >
            <img 
              ...
              alt="Juris Logo" 
              className="w-7 h-7 sm:w-9 sm:h-9 object-contain rounded-md shadow-sm border border-primary/20 transition-transform group-hover:scale-105"
            />
            <h1 className="font-display-lg text-[20px] sm:text-[26px] text-primary tracking-tight font-bold">Juris</h1>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <button 
              className="font-label-sm text-xs text-secondary uppercase tracking-wider hover:text-primary transition-colors px-2 sm:px-3 py-1.5 sm:py-2 cursor-pointer font-medium" 
              onClick={() => onNavigate("login")}
            >
              Log In
            </button>
            <button 
              className="bg-primary text-on-primary font-label-sm text-[11px] sm:text-xs uppercase tracking-wider px-2.5 sm:px-4 py-1.5 sm:py-2 border border-primary hover:bg-surface-container-highest hover:text-primary transition-all duration-200 flex items-center gap-1 sm:gap-2 cursor-pointer shadow-sm active:translate-y-px font-medium whitespace-nowrap"
              onClick={() => onNavigate("register")}
            >
              Get Started <span className="material-symbols-outlined text-[14px] sm:text-[16px]">arrow_forward</span>
            </button>
          </div>
        </div>
      </nav>
      ...
      <main className="flex-1 mt-16 w-full overflow-x-hidden">
        ...
        <section className="border-b-2 border-primary bg-surface relative overflow-hidden">
          ...
          <div className="border-b-2 border-primary bg-surface py-4 sm:py-6 px-3 sm:px-6 md:px-margin text-center">
            <div className="max-w-[1400px] mx-auto flex flex-col items-center">
              <div className="font-label-sm text-[9px] sm:text-[11px] text-secondary uppercase tracking-[0.12em] sm:tracking-[0.25em] mb-2 flex items-center justify-center gap-2 sm:gap-3 text-center">
                <span className="w-4 sm:w-6 h-px bg-primary/40"></span>
                <span>AUTHENTIC CITATION ARCHIVE & CASE RESEARCH SYSTEM</span>
                <span className="w-4 sm:w-6 h-px bg-primary/40"></span>
              </div>
              <h1 className="font-display-lg text-[26px] xs:text-[32px] sm:text-[54px] md:text-[68px] leading-tight text-primary uppercase tracking-[-0.02em] mb-3 break-words text-center">
                THE JURIS LEGAL GAZETTE
              </h1>
              <div className="w-full border-t border-b border-primary/30 py-1.5 flex flex-wrap justify-center sm:justify-between items-center text-[10px] sm:text-[11px] font-label-sm text-secondary uppercase tracking-wider sm:tracking-widest px-2 gap-x-4 gap-y-1 text-center">
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-3 p-4 sm:p-6 bg-parchment-mid border-b-2 lg:border-b-0 lg:border-r-2 border-primary flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between border-b-2 border-primary pb-2 mb-4 sm:mb-6">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <article className="group cursor-pointer" onClick={() => onNavigate("register")}>
                    ...
                    <h4 className="font-headline-md text-sm sm:text-base text-primary font-bold leading-snug group-hover:underline">
              ...
              <div className="mt-6 sm:mt-8 pt-4 border-t border-primary/20 bg-surface p-3 border border-primary/20">
            ...
            <div className="lg:col-span-6 p-4 sm:p-8 md:p-10 bg-surface flex flex-col justify-between">
              <div>
                <div className="font-label-sm text-[11px] sm:text-xs text-secondary uppercase tracking-[0.15em] sm:tracking-[0.2em] mb-2 sm:mb-3 flex items-center gap-2">
                  <span className="w-2 h-2 bg-primary shrink-0"></span>
                  <span>LEAD DISPATCH · PRACTITIONER INTELLIGENCE</span>
                </div>

                <h2 className="font-display-lg text-[22px] xs:text-[26px] sm:text-[38px] md:text-[52px] leading-[1.1] text-primary uppercase mb-3 sm:mb-4 tracking-[-0.02em] break-words">
                  COURT-VERIFIED LEGAL INTELLIGENCE FOR THE INDIAN ADVOCATE.
                </h2>

                <p className="font-headline-md text-[14px] sm:text-[18px] text-secondary italic mb-4 sm:mb-6 leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs font-body-md text-on-surface-variant leading-relaxed pb-4 sm:pb-6 border-b border-primary/20">
                  <p>
              ...
              <div className="mt-6 bg-parchment-deep border-2 border-primary p-3.5 sm:p-5 shadow-[4px_4px_0px_rgba(4,22,39,0.12)]">
                <div className="flex justify-between items-center mb-2.5 sm:mb-3">
                  <span className="font-label-sm text-[10px] sm:text-[11px] font-bold text-primary uppercase tracking-wider">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input 
                    type="text" 
                    readOnly
                    value="Draft anticipatory bail on grounds of parity and lack of custodial interrogation..."
                    className="w-full flex-1 bg-surface border border-primary/40 p-2.5 sm:p-3 font-body-md text-xs text-primary focus:outline-none cursor-default"
                  />
                  <button 
                    className="w-full sm:w-auto bg-primary text-on-primary font-label-sm text-xs uppercase tracking-widest px-4 sm:px-6 py-2.5 sm:py-3 border border-primary hover:bg-surface hover:text-primary transition-all font-bold shrink-0 flex items-center justify-center gap-2 cursor-pointer"
                    onClick={() => onNavigate("register")}
                  >
                    RESEARCH DOCKET
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 mt-3 pt-2.5 border-t border-primary/15 items-center">
                  <span className="font-label-sm text-[10px] text-secondary uppercase">Quick Docket:</span>
                  <button className="font-citation text-[10px] sm:text-[11px] text-primary bg-surface px-2 py-0.5 border border-primary/20 hover:border-primary cursor-pointer" onClick={() => onNavigate("register")}>
                    S.438 Bail
                  </button>
                  <button className="font-citation text-[10px] sm:text-[11px] text-primary bg-surface px-2 py-0.5 border border-primary/20 hover:border-primary cursor-pointer" onClick={() => onNavigate("register")}>
                    Art. 21 Habeas
            ...
            <div className="lg:col-span-3 p-4 sm:p-6 bg-parchment-mid border-t-2 lg:border-t-0 lg:border-l-2 border-primary flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between border-b-2 border-primary pb-2 mb-4 sm:mb-6">
                  <h3 className="font-label-sm text-xs font-bold text-primary uppercase tracking-widest">
        ...
        {/* ── Stats Ledger Strip ─────────────────────────── */}
        <section className="border-b-2 border-primary bg-parchment-mid grid grid-cols-2 md:grid-cols-4 divide-y-2 md:divide-y-0 divide-primary divide-x-2">
          {STATS.map((s, i) => (
            <div key={i} className="py-6 sm:py-8 px-3 sm:px-6 flex flex-col items-center text-center">
              <div className="font-display-lg text-[32px] sm:text-[42px] text-primary mb-1">{s.value}</div>
              <div className="font-label-sm text-[10px] sm:text-xs text-secondary uppercase tracking-[0.15em] sm:tracking-[0.2em]">{s.label}</div>
            </div>
          ))}
        </section>

        {/* ── Features / Research Apparatus ─────────────────── */}
        <section id="features" className="border-b-2 border-primary bg-surface py-12 sm:py-20 px-3 sm:px-6 md:px-margin">
          <div className="max-w-[1400px] mx-auto">
            {/* Section Masthead Header */}
            <div className="border-b-2 border-primary pb-4 sm:pb-6 mb-8 sm:mb-12 flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4">
              <div>
                ...
                <h2 className="font-display-lg text-[26px] sm:text-[36px] md:text-[48px] text-primary uppercase leading-tight break-words">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-2 border-primary divide-y-2 md:divide-y-0 divide-primary">
              {FEATURES.map((f, i) => (
                <div key={i} className="p-5 sm:p-8 bg-surface hover:bg-parchment-mid transition-colors group flex flex-col justify-between md:border-b-2 md:border-r-2 md:border-primary">
                  <div>
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      <span className="material-symbols-outlined text-[28px] sm:text-[32px] text-primary group-hover:scale-105 transition-transform">{f.icon}</span>
                      <span className="font-citation text-xs text-secondary">§ 0{i + 1}</span>
                    </div>
                    <h3 className="font-headline-md text-lg sm:text-xl text-primary font-bold mb-2 sm:mb-3">{f.title}</h3>
                    <p className="font-body-md text-xs sm:text-sm text-on-surface-variant leading-relaxed">{f.desc}</p>
                  </div>
                  <div 
                    className="mt-6 sm:mt-8 pt-4 border-t border-primary/20 flex justify-between items-center text-xs font-label-sm text-secondary uppercase tracking-wider group-hover:text-primary cursor-pointer"
        ...
        <section id="how-it-works" className="border-b-2 border-primary bg-parchment-mid py-12 sm:py-20 px-3 sm:px-6 md:px-margin">
          <div className="max-w-[1400px] mx-auto">
            <div className="border-b-2 border-primary pb-4 sm:pb-6 mb-8 sm:mb-12 flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4">
              <div>
                <div className="font-label-sm text-xs text-secondary uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-2 border-primary bg-surface divide-y-2 md:divide-y-0 md:divide-x-2 divide-primary">
              {STEPS.map((s, i) => (
                <div key={i} className="p-6 sm:p-10 flex flex-col justify-between hover:bg-parchment-deep transition-colors">
                  <div>
                    <div className="flex items-center justify-between border-b border-primary/20 pb-3 sm:pb-4 mb-4 sm:mb-6">
                    ...
                    <h3 className="font-headline-md text-xl sm:text-2xl text-primary font-bold mb-3 sm:mb-4">{s.title}</h3>
                    <p className="font-body-md text-xs sm:text-sm text-on-surface-variant leading-relaxed">{s.desc}</p>
                  </div>
                  <div className="mt-8 sm:mt-12 font-citation text-xs text-secondary flex items-center gap-2">
        ...
        <section className="bg-primary text-on-primary py-12 sm:py-20 px-4 sm:px-margin text-center relative overflow-hidden border-b-2 border-primary">
          <div className="max-w-4xl mx-auto relative z-10">
            <div className="font-label-sm text-[10px] sm:text-xs text-on-primary-container uppercase tracking-[0.15em] sm:tracking-[0.25em] mb-3 sm:mb-4">
              ENROLMENT OPEN · ADVOCATES & RESEARCHERS
            </div>
            <h2 className="font-display-lg text-[26px] sm:text-[44px] md:text-[56px] leading-tight mb-4 sm:mb-6 uppercase break-words">
              Begin Your Legal Research Docket Today
            </h2>
            <p className="font-body-lg text-sm sm:text-base md:text-lg text-on-primary-container max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full max-w-xs sm:max-w-none mx-auto">
              <button 
                className="w-full sm:w-auto bg-surface text-primary font-label-sm text-xs uppercase tracking-widest px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-surface hover:bg-primary hover:text-on-primary transition-colors font-bold flex items-center justify-center gap-2 cursor-pointer"
                onClick={() => onNavigate("register")}
              >
              ...
              <button 
                className="w-full sm:w-auto bg-transparent text-on-primary font-label-sm text-xs uppercase tracking-widest px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-on-primary hover:bg-surface hover:text-primary transition-colors font-bold cursor-pointer"
                onClick={() => onNavigate("login")}
              >
                COUNSEL SIGN IN
              </button>
      ...
      <footer className="bg-surface border-t-2 border-primary py-8 sm:py-12 px-4 sm:px-margin w-full">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between gap-8 sm:gap-12">
          <div className="max-w-md">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-3">
              <img 
                src="/juris_app_icon_dark.png" 
                alt="Juris Logo" 
                className="w-7 h-7 sm:w-8 sm:h-8 object-contain rounded-md border border-primary/30"
              />
              <h2 className="font-display-lg text-[20px] sm:text-[26px] text-primary uppercase tracking-tight">
                THE JURIS LEGAL GAZETTE
              </h2>
            </div>
            <p className="font-body-md text-xs text-secondary leading-relaxed mb-3 sm:mb-4">
            ...
            <div className="font-label-sm text-[10px] sm:text-[11px] text-primary font-bold uppercase tracking-wider">
              NEW DELHI · MUMBAI · BENGALURU
            </div>
          </div>
          
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-6 sm:gap-12 font-label-sm text-xs uppercase tracking-wider">
        ...
        <div className="max-w-[1400px] mx-auto mt-8 sm:mt-12 pt-6 border-t border-primary/20 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left text-xs font-citation text-secondary gap-3">
          <p>© 2026 Juris Legal Systems. All rights reserved.</p>
          <p className="text-[10px] sm:text-[11px]">DISCLAIMER: Juris is a legal intelligence tool and does not constitute formal legal counsel under the Advocates Act, 1961.</p>
        </div>
      </footer>
      ...
      {activeDoc && (
        <div 
          className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 bg-primary/70 backdrop-blur-sm animate-in fade-in duration-200"
          onClick={() => setActiveDocKey(null)}
        >
          <div 
            className="bg-surface border-2 border-primary max-w-2xl w-full max-h-[90vh] sm:max-h-[85vh] flex flex-col shadow-[8px_8px_0px_rgba(4,22,39,0.35)] relative overflow-hidden my-auto"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Gazette Masthead Header */}
            <div className="border-b-2 border-primary bg-parchment-deep p-4 sm:p-5 flex items-start justify-between gap-3 sm:gap-4">
              <div>
                <div className="font-citation text-[10px] sm:text-[11px] font-bold text-secondary uppercase tracking-wider mb-1 flex items-center gap-2">
                  <span className="w-2 h-2 bg-primary shrink-0"></span>
                  <span>{activeDoc.badge}</span>
                </div>
                <h3 className="font-display-lg text-lg sm:text-2xl text-primary uppercase font-bold leading-tight break-words">
                  {activeDoc.title}
                </h3>
              ...
              <button 
                type="button"
                onClick={() => setActiveDocKey(null)}
                className="p-1 sm:p-1.5 border border-primary/40 bg-surface hover:bg-primary hover:text-on-primary text-primary transition-colors cursor-pointer shrink-0"
                aria-label="Close modal"
              >
                <span className="material-symbols-outlined text-[18px] sm:text-[20px] block">close</span>
              </button>
            </div>

            {/* Modal Document Body */}
            <div className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-6 flex-1 bg-surface custom-scrollbar">
              {activeDoc.sections.map((sec, idx) => (
                <div key={idx} className="border-b border-primary/15 pb-3 sm:pb-4 last:border-b-0 last:pb-0">
                  <h4 className="font-headline-md text-sm sm:text-base text-primary font-bold mb-1.5 sm:mb-2">
                    {sec.heading}
                  </h4>
            ...
            <div className="border-t-2 border-primary bg-parchment-mid p-3 sm:p-4 px-4 sm:px-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="font-citation text-[10px] sm:text-[11px] text-secondary text-center sm:text-left">
                AUTHENTICATED DISPATCH · JURIS GAZETTE
              </div>
              <div className="flex items-center justify-end gap-2 sm:gap-3">
                <button 
                  type="button"
                  onClick={() => setActiveDocKey(null)}
                  className="font-label-sm text-xs uppercase tracking-wider px-3 sm:px-4 py-1.5 sm:py-2 border border-primary/40 hover:bg-surface text-primary transition-colors cursor-pointer font-bold"
                >
                  DISMISS
                </button>
                <button 
                  ...
                  className="bg-primary text-on-primary font-label-sm text-xs uppercase tracking-wider px-3 sm:px-4 py-1.5 sm:py-2 border border-primary hover:bg-surface hover:text-primary transition-colors cursor-pointer font-bold flex items-center gap-1.5"
                >
                  ENROL NOW
